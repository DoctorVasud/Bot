...
const prefix = "!"
const groupID = 00000;
const bot_token = "DiscordBotToken";
const rblxCookie = "RobloxCookie";
const officerRoleE = "OfficerRole";
const welcomeMessage = "Welcome to _______!";
const maxXP = 10;
const xpAuditLogChannelID = "PointsLogChannelID";
const mainChatChannelID = "CommandExecutionChannelID";
const fireBaseURL = "https://______.firebaseio.com/";
const xpName = "XP";
/* SETTINGS END */
...
bot.on('message', async message => {
  ...
  const verifiedRole = message.guild.roles.find(role => role.name === "Citizen");
